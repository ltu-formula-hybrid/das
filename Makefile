...
INCLUDE_PATHS = -I. -I./mbed -I$(MBED_DIR)TARGET_LPC1768 -I$(MBED_DIR)TARGET_LPC1768/TARGET_NXP -I$(MBED_DIR)TARGET_LPC1768/TARGET_NXP/TARGET_LPC176X -I$(MBED_DIR)TARGET_LPC1768/TARGET_NXP/TARGET_LPC176X/TARGET_MBED_LPC1768 -I$(MBED_DIR)TARGET_LPC1768/TOOLCHAIN_GCC_ARM 
